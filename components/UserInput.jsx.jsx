  ...
  return (
    ...
    >
      <div className="flex items-center text-btntext  justify-center w-full  md:w-[500px] lg:w-1/2  px-5  my-auto mx-auto text-sm  lg:text-lg rounded-md mt-10">
        <HomeGradientBorder>
          <div
            className="bg-[#f8f8f8] text-black flex items-center  ml-1 pl-2 md:my-[2px] xm:text-[10px]  text-sm"
          >
    ...
    <p className="text-center mt-5 text-gray-600">It’s free and takes just a minute to get started.</p>
    </div>
  );
};
